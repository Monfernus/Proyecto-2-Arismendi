...
public class Inicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenido a Hotel Caracas");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 50, 450, 90));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 10, 60, 50));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Dubai", 0, 24)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("Bienvenido al sistema de reservaciones \nde uno de los hoteles mas prestigiosos\n  de Caracas,  como deseas empezar?");
        jScrollPane1.setViewportView(jTextArea1);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, 400, 220));

        Menu.setText("Ir a menu principal");
        Menu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MenuActionPerformed(evt);
            }
        });
        jPanel1.add(Menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 370, 140, 60));
